  ...
  const renderPage = () => {
    ...
    if (page === "dashboard") {
      ...
      return user.role === "driver" 
        ...
        : <UserDashboard user={user} token={token!} ws={ws} onRideBooked={() => {}} onUserUpdate={setUser} />;
    }

    if (page === "history") {
      if (!user) return <Auth onAuth={handleAuth} />;
      return <UserDashboard user={user} token={token!} ws={ws} onRideBooked={() => {}} onUserUpdate={setUser} />;
    }
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-bold mb-6">
                ...
                <span className="font-display uppercase tracking-wider text-xs">Fastest Cab Service in Town</span>
              </div>
              <h1 className="text-7xl lg:text-9xl font-display font-black tracking-tighter text-zinc-900 leading-[0.85] mb-8">
                Ride with <br />
                <span className="text-emerald-500 italic">Confidence.</span>
              </h1>
